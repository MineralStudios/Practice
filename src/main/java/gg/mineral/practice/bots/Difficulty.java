        ...
        public FakePlayer spawn(Profile profile, Location location, String suffix) {
            BotConfiguration config = BotConfiguration.builder().location(location).name("EasyBot" + suffix)
                    .aimConfiguration(AimConfiguration.builder().horizontalAimSpeed(0.35F).verticalAimSpeed(0.35F)
                            .horizontalAimAccuracy(0.35F)
                            .verticalAimAccuracy(0.35F).build())
                    .cps(5).bowAimingRadius(2.4F).latency(50)
        ...
        public FakePlayer spawn(Profile profile, Location location, String suffix) {
            BotConfiguration config = BotConfiguration.builder().location(location).name("MediumBot" + suffix)
                    .aimConfiguration(AimConfiguration.builder().horizontalAimSpeed(0.5F).verticalAimSpeed(0.5F)
                            .horizontalAimAccuracy(0.5F)
                            .verticalAimAccuracy(0.5F).build())
                    .cps(8).bowAimingRadius(1.2f).latency(50)
        ...
        public FakePlayer spawn(Profile profile, Location location, String suffix) {
            BotConfiguration config = BotConfiguration.builder().location(location).name("HardBot" + suffix)
                    .aimConfiguration(AimConfiguration.builder().horizontalAimSpeed(0.65F).verticalAimSpeed(0.65F)
                            .horizontalAimAccuracy(0.65F)
                            .verticalAimAccuracy(0.65F).build())
                    .cps(11).bowAimingRadius(0.6f).latency(50)
        ...
        public FakePlayer spawn(Profile profile, Location location, String suffix) {
            BotConfiguration config = BotConfiguration.builder().location(location).name("ExpertBot" + suffix)
                    .aimConfiguration(AimConfiguration.builder().horizontalAimSpeed(0.8F).verticalAimSpeed(0.8F)
                            .horizontalAimAccuracy(0.8F)
                            .verticalAimAccuracy(0.8F).build())
                    .cps(14).bowAimingRadius(0.3f).latency(50)
        ...
        public FakePlayer spawn(Profile profile, Location location, String suffix) {
            ...
            BotConfiguration config = BotConfiguration.builder().location(location).name("ProBot" + suffix)
                    .aimConfiguration(AimConfiguration.builder().horizontalAimSpeed(0.95F).verticalAimSpeed(0.95F)
                            .horizontalAimAccuracy(0.95F)
                            .verticalAimAccuracy(0.95F).build())
                    .cps(17).bowAimingRadius(0.2f).latency(50)
