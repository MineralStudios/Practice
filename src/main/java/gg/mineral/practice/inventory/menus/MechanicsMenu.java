    ...
    public void update() {
        ...
        setSlot(11,
                ItemStacks.CHANGE_KNOCKBACK
                        ...
                        .build(),
                interaction -> interaction.getProfile().openMenu(new CreateCustomKnockbackMenu(this, this)));
        ...
        setSlot(12, ItemStacks.HIT_DELAY
                ...
                interaction -> interaction.getProfile()
                        .openMenu(
                                ConfigureValueMenu.of(this, duelSettings::setNoDamageTicks, int.class)));
        ...
        setSlot(19, ItemStacks.PEARL_COOLDOWN
                ...
                interaction -> interaction.getProfile()
                        .openMenu(
                                ConfigureValueMenu.of(this, duelSettings::setPearlCooldown, int.class)));
        ...
        setSlot(20, ItemStacks.ARENA
                ...
                .build(), interaction -> interaction.getProfile().openMenu(new SelectArenaMenu(this, this, submitAction)));
        ...
        if (prevMenu != null)
            setSlot(38, ItemStacks.BACK, interaction -> interaction.getProfile().openMenu(prevMenu));

        setSlot(42, ItemStacks.RESET_SETTINGS, interaction -> {
            viewer.resetDuelSettings();
            reload();
        });

        setSlot(40, ItemStacks.SUBMIT, interaction -> {
