...
import gg.mineral.core.utils.message.ClickableChatMessage;
import gg.mineral.core.utils.message.ListElementMessage;
...
public class ChatMessages {
	...
	public static final ChatMessage BEDWARS_ARENA_SPAWN_SET = new ChatMessage(
			"The bedwars spawn location for the %arena% arena has been set to your location.", CC.YELLOW)
			.highlightText(CC.GOLD, "%arena%", "your location");
	...
	public static final ChatMessage ARENA_SPAWN = new ListElementMessage("/arena spawn <Arena> <1/2/Waiting>",
			CC.SECONDARY);
	public static final ChatMessage BEDWARS_ARENA_SPAWN = new ListElementMessage("/bedwarsarena spawn <Arena> <Color>",
			CC.SECONDARY);
