 ...
 * just like ArrayList.
 * In ArrayList when there is no space for it it creates new array with double
 * of old size and inserts old data into new one.
 * Unlike ArrayList GlueList does it dynamically way with creating new node so
 * old data does NOT have to be moved to another array.
 ...
 * If you insert 10_000_000 record into List there will be just 36 nodes.<br>
 * <br>
 * Worst Case<br>
 * Add O(n*m)<br>
 * Remove O(n*m)<br>
